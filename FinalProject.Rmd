...
```{r}
sites_per_year %>% 
  filter(hospital_name == "Albany Medical Center") %>% 
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "widgets",
              h1(strong("These are plots produced based on which procedures, specifically which cardiac surgery procedure, were performed for each patient in New York Hospitals."), style = "font-size:20px"),
        fluidRow(
