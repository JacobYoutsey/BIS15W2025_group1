...
ggmap(map1) + 
  geom_point(data = cardiac, aes(facility_longitude, facility_latitude, size = number_of_cases, color = number_of_cases)) + #WE just add the chart in without using ggplot! 
